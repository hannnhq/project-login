                ...
                <div class="login-form login-signin">
                    ...
                    <form class="form" action="{{route('login.submit')}}" method="POST" novalidate="novalidate" id="">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Chào mừng</h3>
                            <span class="text-muted font-weight-bold font-size-h4">Bạn chưa có tài khoản?
                            <a href="{{route('signup.user')}}" class="text-primary font-weight-bolder">Đăng ký tài khoản</a></span>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a href="{{route('forgotpassword')}}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Quên mật khẩu ?</a>
                            </div>
